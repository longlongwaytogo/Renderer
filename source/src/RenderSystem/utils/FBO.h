...
namespace RenderSystem
{
	...
	public:
		...
		void AddDepthStencilAttachment(int w = 800, int h = 600)
		{
		...
		void AddRBOAttachmentt(GLenum attachmentId, int w = 800, int h = 600)
		{
			unsigned int rbo;
		...
		void AddColorAttachment(GLenum attachmentId, int w = 800, int h = 600)
		{
