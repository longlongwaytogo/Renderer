...
class ibl_irradiance :public TestBase
{
public:
	virtual void InitShader()
	{
		...
		m_bprShader.loadFile(path + "2.1.2.ibl_irradiance.vs", path + "2.1.2.ibl_irradiance.ps");
		m_backgroundShader.loadFile(path + "2.1.2.background.vs", path + "2.1.2.background.ps");
