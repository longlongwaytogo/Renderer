...
class lighting_maps_exercise4 :public TestBase
{
public:
	virtual void InitShader()
	{
		...
		m_lightingShader.loadFile(shaderPath + "4.3.lighting_maps_exercise4.vs", shaderPath + "4.3.lighting_maps_exercise4.ps");
...
START_TEST(lighting_maps_exercise4)