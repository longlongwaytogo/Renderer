...
class Specular_Color :public TestBase
{
public:
	virtual void InitShader()
	{
		...
		m_lightingShader.loadFile(shaderPath + "3.basic_lighting_specular.vs", shaderPath + "3.basic_lighting_specular.ps");
